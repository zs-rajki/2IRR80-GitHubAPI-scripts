...
export type RestEndpointMethodTypes = {
    ...
    dependabot: {
        ...
        repositoryAccessForOrg: {
            parameters: RequestParameters & Endpoints["GET /organizations/{org}/dependabot/repository-access"]["parameters"];
            response: Endpoints["GET /organizations/{org}/dependabot/repository-access"]["response"];
        };
        setRepositoryAccessDefaultLevel: {
            parameters: RequestParameters & Endpoints["PUT /organizations/{org}/dependabot/repository-access/default-level"]["parameters"];
        ...
        updateRepositoryAccessForOrg: {
            parameters: RequestParameters & Endpoints["PATCH /organizations/{org}/dependabot/repository-access"]["parameters"];
    ...
    issues: {
        ...
        addBlockedByDependency: {
            parameters: RequestParameters & Endpoints["POST /repos/{owner}/{repo}/issues/{issue_number}/dependencies/blocked_by"]["parameters"];
        ...
        getParent: {
            parameters: RequestParameters & Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/parent"]["parameters"];
        ...
        listDependenciesBlockedBy: {
            parameters: RequestParameters & Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/dependencies/blocked_by"]["parameters"];
            response: Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/dependencies/blocked_by"]["response"];
        };
        listDependenciesBlocking: {
            parameters: RequestParameters & Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/dependencies/blocking"]["parameters"];
        ...
        removeDependencyBlockedBy: {
            parameters: RequestParameters & Endpoints["DELETE /repos/{owner}/{repo}/issues/{issue_number}/dependencies/blocked_by/{issue_id}"]["parameters"];
    ...
    orgs: {
        ...
        createArtifactStorageRecord: {
            parameters: RequestParameters & Endpoints["POST /orgs/{org}/artifacts/metadata/storage-record"]["parameters"];
        ...
        deleteAttestationsBulk: {
            parameters: RequestParameters & Endpoints["POST /orgs/{org}/attestations/delete-request"]["parameters"];
            response: Endpoints["POST /orgs/{org}/attestations/delete-request"]["response"];
        };
        deleteAttestationsById: {
            parameters: RequestParameters & Endpoints["DELETE /orgs/{org}/attestations/{attestation_id}"]["parameters"];
            response: Endpoints["DELETE /orgs/{org}/attestations/{attestation_id}"]["response"];
        };
        deleteAttestationsBySubjectDigest: {
            parameters: RequestParameters & Endpoints["DELETE /orgs/{org}/attestations/digest/{subject_digest}"]["parameters"];
        ...
        listArtifactStorageRecords: {
            parameters: RequestParameters & Endpoints["GET /orgs/{org}/artifacts/{subject_digest}/metadata/storage-records"]["parameters"];
        ...
        listAttestationsBulk: {
            parameters: RequestParameters & Endpoints["POST /orgs/{org}/attestations/bulk-list{?per_page,before,after}"]["parameters"];
    ...
    projects: {
        addItemForOrg: {
            parameters: RequestParameters & Endpoints["POST /orgs/{org}/projectsV2/{project_number}/items"]["parameters"];
            response: Endpoints["POST /orgs/{org}/projectsV2/{project_number}/items"]["response"];
        };
        addItemForUser: {
            parameters: RequestParameters & Endpoints["POST /users/{user_id}/projectsV2/{project_number}/items"]["parameters"];
            response: Endpoints["POST /users/{user_id}/projectsV2/{project_number}/items"]["response"];
        };
        deleteItemForOrg: {
            parameters: RequestParameters & Endpoints["DELETE /orgs/{org}/projectsV2/{project_number}/items/{item_id}"]["parameters"];
            response: Endpoints["DELETE /orgs/{org}/projectsV2/{project_number}/items/{item_id}"]["response"];
        };
        deleteItemForUser: {
            parameters: RequestParameters & Endpoints["DELETE /users/{user_id}/projectsV2/{project_number}/items/{item_id}"]["parameters"];
            response: Endpoints["DELETE /users/{user_id}/projectsV2/{project_number}/items/{item_id}"]["response"];
        };
        getFieldForOrg: {
            parameters: RequestParameters & Endpoints["GET /orgs/{org}/projectsV2/{project_number}/fields/{field_id}"]["parameters"];
            response: Endpoints["GET /orgs/{org}/projectsV2/{project_number}/fields/{field_id}"]["response"];
        };
        getFieldForUser: {
            parameters: RequestParameters & Endpoints["GET /users/{user_id}/projectsV2/{project_number}/fields/{field_id}"]["parameters"];
            response: Endpoints["GET /users/{user_id}/projectsV2/{project_number}/fields/{field_id}"]["response"];
        };
        getForOrg: {
            parameters: RequestParameters & Endpoints["GET /orgs/{org}/projectsV2/{project_number}"]["parameters"];
            response: Endpoints["GET /orgs/{org}/projectsV2/{project_number}"]["response"];
        };
        getForUser: {
            parameters: RequestParameters & Endpoints["GET /users/{user_id}/projectsV2/{project_number}"]["parameters"];
            response: Endpoints["GET /users/{user_id}/projectsV2/{project_number}"]["response"];
        };
        getOrgItem: {
            parameters: RequestParameters & Endpoints["GET /orgs/{org}/projectsV2/{project_number}/items/{item_id}"]["parameters"];
            response: Endpoints["GET /orgs/{org}/projectsV2/{project_number}/items/{item_id}"]["response"];
        };
        getUserItem: {
            parameters: RequestParameters & Endpoints["GET /users/{user_id}/projectsV2/{project_number}/items/{item_id}"]["parameters"];
            response: Endpoints["GET /users/{user_id}/projectsV2/{project_number}/items/{item_id}"]["response"];
        };
        listFieldsForOrg: {
            parameters: RequestParameters & Endpoints["GET /orgs/{org}/projectsV2/{project_number}/fields"]["parameters"];
            response: Endpoints["GET /orgs/{org}/projectsV2/{project_number}/fields"]["response"];
        };
        listFieldsForUser: {
            parameters: RequestParameters & Endpoints["GET /users/{user_id}/projectsV2/{project_number}/fields"]["parameters"];
            response: Endpoints["GET /users/{user_id}/projectsV2/{project_number}/fields"]["response"];
        };
        listForOrg: {
            parameters: RequestParameters & Endpoints["GET /orgs/{org}/projectsV2"]["parameters"];
            response: Endpoints["GET /orgs/{org}/projectsV2"]["response"];
        };
        listForUser: {
            parameters: RequestParameters & Endpoints["GET /users/{username}/projectsV2"]["parameters"];
            response: Endpoints["GET /users/{username}/projectsV2"]["response"];
        };
        listItemsForOrg: {
            parameters: RequestParameters & Endpoints["GET /orgs/{org}/projectsV2/{project_number}/items"]["parameters"];
            response: Endpoints["GET /orgs/{org}/projectsV2/{project_number}/items"]["response"];
        };
        listItemsForUser: {
            parameters: RequestParameters & Endpoints["GET /users/{user_id}/projectsV2/{project_number}/items"]["parameters"];
            response: Endpoints["GET /users/{user_id}/projectsV2/{project_number}/items"]["response"];
        };
        updateItemForOrg: {
            parameters: RequestParameters & Endpoints["PATCH /orgs/{org}/projectsV2/{project_number}/items/{item_id}"]["parameters"];
            response: Endpoints["PATCH /orgs/{org}/projectsV2/{project_number}/items/{item_id}"]["response"];
        };
        updateItemForUser: {
            parameters: RequestParameters & Endpoints["PATCH /users/{user_id}/projectsV2/{project_number}/items/{item_id}"]["parameters"];
    ...
    secretScanning: {
        ...
        listOrgPatternConfigs: {
            parameters: RequestParameters & Endpoints["GET /orgs/{org}/secret-scanning/pattern-configurations"]["parameters"];
        ...
        updateOrgPatternConfigs: {
            parameters: RequestParameters & Endpoints["PATCH /orgs/{org}/secret-scanning/pattern-configurations"]["parameters"];
    ...
    users: {
        ...
        deleteAttestationsBulk: {
            parameters: RequestParameters & Endpoints["POST /users/{username}/attestations/delete-request"]["parameters"];
            response: Endpoints["POST /users/{username}/attestations/delete-request"]["response"];
        };
        deleteAttestationsById: {
            parameters: RequestParameters & Endpoints["DELETE /users/{username}/attestations/{attestation_id}"]["parameters"];
            response: Endpoints["DELETE /users/{username}/attestations/{attestation_id}"]["response"];
        };
        deleteAttestationsBySubjectDigest: {
            parameters: RequestParameters & Endpoints["DELETE /users/{username}/attestations/digest/{subject_digest}"]["parameters"];
        ...
        listAttestationsBulk: {
            parameters: RequestParameters & Endpoints["POST /users/{username}/attestations/bulk-list{?per_page,before,after}"]["parameters"];
